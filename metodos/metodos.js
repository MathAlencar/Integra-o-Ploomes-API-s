...
export class Garantidores extends fieldPloomes{
  ...
  quantidadeGarantidores(qtd) {
    this.Dados.push(this.ObjectFormat_Integer('deal_11FEABD2-5EC2-4229-A9A8-381792171486', qtd));  // Quantidade de garantidores
  }
...
export class Tomadores extends fieldPloomes{
  constructor(Array){
    super()
    this.Dados = Array
  }
  ...
  tomador_um(
    ...
    this.Dados.push(this.ObjectFormat_String('deal_CD4023CD-5AD0-4BF6-9CFD-A6D14B5E7F45', T1_FormaComprovacaoRendaInformal)); // Comprovação informal (T1)
    this.Dados.push(this.ObjectFormat_String('deal_598CB204-116D-4356-AE57-C155C2745151', T1_ProfissaoQualificacao)); // Qualificação da profissão (T1)
    ...
    this.Dados.push(this.ObjectFormat_String(
      ...
      T1_Nascimento
    )); // Tomador 1 - Data de nascimento
    this.Dados.push(this.ObjectFormat_String(
      'deal_645BF29A-E989-4124-AC68-5AAAC5FE180A',
      T1_PFouPJ
    )); // Tomador 1 - PF ou PJ
    this.Dados.push(this.ObjectFormat_String(
    ...
    this.Dados.push(this.ObjectFormat_String(
      'deal_BF2A8CBD-B877-4795-BAA4-8440B189725F',
      T1_EstadoCivil
    )); // Tomador 1 - Estado Civil
    this.Dados.push(this.ObjectFormat_String(
  ...
  tomador_dois(
    ...
    this.Dados.push(this.ObjectFormat_Decimal('deal_6A6E970E-716C-4C78-A050-3AD70520E762', T2_RendaInformal)); // Renda informal (T2)
    this.Dados.push(this.ObjectFormat_String('deal_707EA962-CBDD-4995-9815-F4098AF0F2BA', T2_FormaComprovacaoRendaInformal)); // Comprovação informal (T2)
    this.Dados.push(this.ObjectFormat_String('deal_3216DE9D-B056-409E-8943-B6F0EEE48648', T2_ProfissaoQualificacao)); // Qualificação da profissão (T2)
  ...
  tomador_tres(
    ...
    this.Dados.push(this.ObjectFormat_Decimal('deal_FFABC28E-585E-4D44-89F7-332E7B274E33', T3_RendaInformal)); // Renda informal (T3)
    this.Dados.push(this.ObjectFormat_String('deal_7780AF73-F8C9-4D10-B983-CD1125334A03', T3_FormaComprovacaoRendaInformal)); // Comprovação informal (T3)
    this.Dados.push(this.ObjectFormat_String('deal_307A551D-3F1F-4981-BC9F-715C519F3172', T3_ProfissaoQualificacao)); // Qualificação da profissão (T3)
  ...
  tomador_quatro(
    ...
    this.Dados.push(this.ObjectFormat_String('deal_D28915DE-9DE2-4630-B9B0-EEF0B7D38298', T3_ProfissaoQualificacao)); // Qualificação da profissão (T4)
    this.Dados.push(this.ObjectFormat_Decimal('deal_F4ABC681-681A-4E96-BE15-A72C58D635B1', T3_RendaInformal)); // Renda informal (T4)
    this.Dados.push(this.ObjectFormat_String('deal_25291286-3AF7-4F9B-A73B-174BA5A129C2', T3_FormaComprovacaoRendaInformal)); // Comprovação informal (T4)
...
export class DemaisInformacoes extends fieldPloomes{
  ...
  informacoesEmprestimo(taxaJuros, valor, prazo, amortizacao, carencia) {
    ...
    this.Dados.push(this.ObjectFormat_String('deal_EB71244F-6B18-41F3-AC2E-5AA14F777177', amortizacao));   // Amortização (SOLICITADO)
  ...
  condicoesGarantia(
    ...
    this.Dados.push(this.ObjectFormat_String('deal_B2446B4C-776E-4B39-8C90-54E02BF69398', pertenceTomador));      // A garantia pertence ao tomador?
    ...
    this.Dados.push(this.ObjectFormat_String('deal_CF20FE57-AC53-4620-ADAC-7E5BB998B1B8', cidade));              // Cidade da garantia (ALTERADO)
    this.Dados.push(this.ObjectFormat_String('deal_9D3E7497-34EC-4BE5-9593-4346B2CC0E82', quitada));             // Garantia quitada?
    this.Dados.push(this.ObjectFormat_String('deal_73DD1B4C-3B2D-45C9-8B74-73EF963D0A58', ruralUrbano));         // Rural ou urbano
    this.Dados.push(this.ObjectFormat_String('deal_1AA48C68-4279-4AD5-B094-0DA5ED6C5DDB', endereco));           // Endereço da garantia
    this.Dados.push(this.ObjectFormat_String('deal_FD4FD389-3AC3-40B0-900D-62641284B58B', unidadeFederativa));   // Unidade federativa
    this.Dados.push(this.ObjectFormat_String('deal_C5F21FEF-CB57-4B04-90B4-7617BFD79C97', matricula));          // Matrícula/escritura
    this.Dados.push(this.ObjectFormat_String('deal_5B0F88B4-448E-4911-ABDA-3FD7F126D50B', nomeNaMatricula));   // Nome do garantidor está na matrícula?
    this.Dados.push(this.ObjectFormat_String('deal_4C751B3D-4086-4519-B26C-74DA1018BB8E', averbado));           // Imóvel averbado?
    this.Dados.push(this.ObjectFormat_String('deal_A3077788-CB0B-4D43-9B17-6C83047A7A44', usufruto));           // Possui usufruto?
    this.Dados.push(this.ObjectFormat_String('deal_1FC9032C-3940-4A2A-8243-3BC7310D91A8', inventario));          // Processo de inventário?
  }
